...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("Smart Organizer");
        }
        ...
        Intent curTab = getIntent();
        Bundle current = curTab.getExtras();
        if(current != null){
            currentTab = (int) current.get("currentTab");
        }
        else { currentTab = 0; }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Developed by A.Kovalchuk 2018", Toast.LENGTH_LONG).show();
            return true;
        }
